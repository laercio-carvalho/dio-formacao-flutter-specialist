...
//import 'package:funcoes/funcoes_calculadora.dart' as calculadora;
...
void main(List<String> arguments) {
  ...
  var operacao = lerConsole("Informe a operacao matematica: (+, -, *, /)");
...
double lerConsoleDouble(String texto) {
  ...
  if(numero  == null){
    print("Numero informado incorreto, alternado para 0");
    return 0.0;
  } else {
    return numero;
  }
